...
COS_API_KEY_ID="IaUnOwUyQIk73hgVONSa1rAXov42Rcx5_i6PC0HblqmV "
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/d12e6997cef346a6abb2774f83dcc825:645824b6-fc39-43b4-8262-f343fb5b3ef7::"
...
@app.route('/')
def index():
    files = get_bucket_contents('ret124')
