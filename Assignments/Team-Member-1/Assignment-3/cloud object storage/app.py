...
COS_API_KEY_ID="wES1swFSrjp_nGWpNWl7C3npNip3Jid7Wmfu51O935cm"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/ed59c7267ebd41e5a2ffe1411438d479:ec369dd7-79e7-4050-aa69-2dc8b6e2429a::"
...
@app.route('/')
def index():
    files = get_bucket_contents('ret12345')
