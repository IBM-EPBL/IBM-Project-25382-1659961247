...
COS_API_KEY_ID = "Feyt9-Y1SXNsMAwpeiB-1GAKR4OgsPJegHV85DPnByQu"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/d91981149b654847bc374a2b68e9e498:742ad2d3-8c60-47a2-b048-25f6e11ed9d8::"
...
@app.route('/')
def index():
    files = get_bucket_contents('ret123')
